...
public class ADParserTestForkNode {
	...
	public void TestNodesFork1() {
		...
		expected.append("init1_fork1_t = update_fork1.1!(1-0) -> ((ce_fork1.1 -> SKIP))\n" + 
				...
				"act1_fork1 = ce_fork1.2 -> lock_act1_fork1.lock -> event_act1_fork1 -> lock_act1_fork1.unlock -> update_fork1.3!(1-1) -> ((ce_fork1.4 -> SKIP)); act1_fork1\n" + 
				"act1_fork1_t = act1_fork1 /\\ END_DIAGRAM_fork1\n" + 
				"act2_fork1 = ce_fork1.3 -> lock_act2_fork1.lock -> event_act2_fork1 -> lock_act2_fork1.unlock -> update_fork1.4!(1-1) -> ((ce_fork1.5 -> SKIP)); act2_fork1\n" + 
	...
	public void TestNodesFork2() {
		...
		expected.append("parameter_x_t = update_fork2.1!(1-0) -> get_x_fork2.1?x -> ((oe_x_fork2.1!x -> SKIP))\n" + 
				...
				"act1_fork2 = oe_x_fork2.2?x -> lock_act1_fork2.lock -> event_act1_fork2 -> lock_act1_fork2.unlock -> update_fork2.3!(1-1) -> ((oe_x_fork2.4!x -> SKIP)); act1_fork2\n" + 
				"act1_fork2_t = act1_fork2 /\\ END_DIAGRAM_fork2\n" + 
				"act2_fork2 = oe_x_fork2.3?x -> lock_act2_fork2.lock -> event_act2_fork2 -> lock_act2_fork2.unlock -> update_fork2.4!(1-1) -> ((oe_x_fork2.5!x -> SKIP)); act2_fork2\n" + 
				"act2_fork2_t = act2_fork2 /\\ END_DIAGRAM_fork2\n" + 
				"fin1_fork2 = ((oe_x_fork2.5?x -> SKIP) [] (oe_x_fork2.4?x -> SKIP)); clear_fork2.1 -> SKIP\n" + 
