...
public class ADParserTestForkNode {
	...
	public void TestNodesFork1() {
		...
		expected.append("init1_fork1_t = update_fork1.1!(1-0) -> ((cn_fork1.1 -> SKIP))\n" + 
				"fork1_fork1 = cn_fork1.1 -> update_fork1.2!(2-1) -> ((cn_fork1.2 -> SKIP) ||| (cn_fork1.3 -> SKIP)); fork1_fork1\n" + 
				"fork1_fork1_t = fork1_fork1 /\\ END_DIAGRAM_fork1\n" + 
				"act1_fork1 = cn_fork1.2 -> lock_act1_fork1.lock -> event_act1_fork1 -> lock_act1_fork1.unlock -> update_fork1.3!(1-1) -> cn_fork1.4 -> act1_fork1\n" + 
				"act1_fork1_t = act1_fork1 /\\ END_DIAGRAM_fork1\n" + 
				"act2_fork1 = cn_fork1.3 -> lock_act2_fork1.lock -> event_act2_fork1 -> lock_act2_fork1.unlock -> update_fork1.4!(1-1) -> cn_fork1.5 -> act2_fork1\n" + 
				"act2_fork1_t = act2_fork1 /\\ END_DIAGRAM_fork1\n" + 
				"fin1_fork1 = ((cn_fork1.5 -> SKIP) [] (cn_fork1.4 -> SKIP)); clear_fork1.1 -> SKIP\n" + 
