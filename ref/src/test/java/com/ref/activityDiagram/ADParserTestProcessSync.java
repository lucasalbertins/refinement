...
public class ADParserTestProcessSync {
	...
	public void TestNodesProcessSync2() {
		...
		StringBuffer expected = new StringBuffer();
		expected.append("Node_decision1 = ((((dec1_decision1_t [{|cn_decision1.1,update_decision1.2,get_x_decision1.1,cn_decision1.2,cn_decision1.3,endDiagram_decision1|}||{|update_decision1.1,cn_decision1.1,endDiagram_decision1|}] init_decision1_t) [{|cn_decision1.1,update_decision1.2,get_x_decision1.1,cn_decision1.2,cn_decision1.3,endDiagram_decision1,update_decision1.1|}||{|cn_decision1.2,lock_act1_decision1,event_act1_decision1,update_decision1.3,cn_decision1.4,endDiagram_decision1|}] act1_decision1_t) [{|cn_decision1.1,update_decision1.2,get_x_decision1.1,cn_decision1.2,cn_decision1.3,endDiagram_decision1,update_decision1.1,lock_act1_decision1,event_act1_decision1,update_decision1.3,cn_decision1.4|}||{|cn_decision1.5,cn_decision1.4,clear_decision1.1,endDiagram_decision1|}] fin1_decision1_t) [{|cn_decision1.1,update_decision1.2,get_x_decision1.1,cn_decision1.2,cn_decision1.3,endDiagram_decision1,update_decision1.1,lock_act1_decision1,event_act1_decision1,update_decision1.3,cn_decision1.4,cn_decision1.5,clear_decision1.1|}||{|cn_decision1.3,lock_act2_decision1,event_act2_decision1,update_decision1.4,cn_decision1.5,endDiagram_decision1|}] act2_decision1_t)\n");
	...
	public void TestNodesProcessSync3() {
		...
		StringBuffer expected = new StringBuffer();
		expected.append("Node_action1 = ((init_action1_t [{|update_action1.1,cn_action1.1,endDiagram_action1|}||{|cn_action1.1,lock_act1_action1,event_act1_action1,update_action1.2,cn_action1.2,endDiagram_action1|}] act1_action1_t) [{|update_action1.1,cn_action1.1,endDiagram_action1,lock_act1_action1,event_act1_action1,update_action1.2,cn_action1.2|}||{|cn_action1.2,clear_action1.1,endDiagram_action1|}] fin1_action1_t)\n");
