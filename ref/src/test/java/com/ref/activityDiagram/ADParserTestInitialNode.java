...
public class ADParserTestInitialNode {
	...
	public void TestNodesInitial2() {
		...
		expected.append("init1_initial2_t = update_initial2.1!(1-0) -> ((ce_initial2.1 -> SKIP))\n" + 
				"act1_initial2 = ce_initial2.1 -> lock_act1_initial2.lock -> event_act1_initial2 -> lock_act1_initial2.unlock -> update_initial2.2!(1-1) -> ((ce_initial2.2 -> SKIP)); act1_initial2\n" + 
				...
				"act2_initial2 = ce_initial2.3 -> lock_act2_initial2.lock -> event_act2_initial2 -> lock_act2_initial2.unlock -> update_initial2.4!(1-1) -> ((ce_initial2.4 -> SKIP)); act2_initial2\n" + 
