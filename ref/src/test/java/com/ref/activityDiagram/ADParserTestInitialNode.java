...
public class ADParserTestInitialNode {
	...
	public void TestNodesInitial2() {
		...
		expected.append("init1_initial2_t = update_initial2.1!(1-0) -> ((ce_initial2.1 -> SKIP))\n" + 
				"act1_initial2 = ((ce_initial2.1 -> SKIP)); lock_act1_initial2.lock -> event_act1_initial2 -> lock_act1_initial2.unlock -> update_initial2.2!(1-1) -> ((ce_initial2.2 -> SKIP)); act1_initial2\n" + 
				"act1_initial2_t = act1_initial2 /\\ END_DIAGRAM_initial2\n" + 
				"init2_initial2_t = update_initial2.3!(1-0) -> ((ce_initial2.3 -> SKIP))\n" + 
				"act2_initial2 = ((ce_initial2.3 -> SKIP)); lock_act2_initial2.lock -> event_act2_initial2 -> lock_act2_initial2.unlock -> update_initial2.4!(1-1) -> ((ce_initial2.4 -> SKIP)); act2_initial2\n" + 
	...
	public void TestNodesInitial3() {
		...
		expected.append("init1_join1_t = update_join1.1!(2-0) -> ((ce_join1.1 -> SKIP) ||| (ce_join1.2 -> SKIP))\n" + 
				...
				"act2_join1 = ((ce_join1.2 -> SKIP)); lock_act2_join1.lock -> event_act2_join1 -> lock_act2_join1.unlock -> update_join1.3!(1-1) -> ((ce_join1.5 -> SKIP)); act2_join1\n" + 
				"act2_join1_t = act2_join1 /\\ END_DIAGRAM_join1\n" + 
				"join1_join1 = ((ce_join1.3 -> SKIP) ||| (ce_join1.5 -> SKIP)); update_join1.4!(1-2) -> ((ce_join1.4 -> SKIP)); join1_join1\n" + 
	...
	public void TestNodesInitial4() {
		...
		expected.append("init1_decision1_t = update_decision1.1!(1-0) -> ((ce_decision1.1 -> SKIP))\n" + 
				"act1_decision1 = ((ce_decision1.2 -> SKIP)); lock_act1_decision1.lock -> event_act1_decision1 -> lock_act1_decision1.unlock -> update_decision1.2!(1-1) -> ((ce_decision1.4 -> SKIP)); act1_decision1\n" + 
				"act1_decision1_t = act1_decision1 /\\ END_DIAGRAM_decision1\n" + 
				"parameter_x_decision1_t = update_decision1.3!(1-0) -> get_x_decision1.1?x -> ((oe_x_decision1.1!x -> SKIP))\n" +
				"act2_decision1 = ((ce_decision1.3 -> SKIP)); lock_act2_decision1.lock -> event_act2_decision1 -> lock_act2_decision1.unlock -> update_decision1.4!(1-1) -> ((ce_decision1.5 -> SKIP)); act2_decision1\n" + 
				"act2_decision1_t = act2_decision1 /\\ END_DIAGRAM_decision1\n" + 
				"dec1_decision1 = ((ce_decision1.1 -> SKIP) ||| (oe_x_decision1.1?x -> set_x_dec1_decision1.1!x -> SKIP)); update_decision1.5!(1-2) -> get_x_dec1_decision1.2?x -> (x == 1 & (dc -> ce_decision1.2 -> SKIP) [] x == 0 & (dc -> ce_decision1.3 -> SKIP)); dec1_decision1\n" +
	...
	public void TestNodesInitial5() {
		...
		expected.append("parameter_z_decision3_t = update_decision3.1!(1-0) -> get_z_decision3.1?z -> ((oe_z_decision3.1!z -> SKIP))\n" +
				"dec1_decision3 = oe_z_decision3.1?z -> update_decision3.2!(1-1) -> (z > 0 & (dc -> oe_z_decision3.2!z -> SKIP) [] z <= 0 & (dc -> oe_z_decision3.3!z -> SKIP)); dec1_decision3\n" +
	...
	public void TestNodesInitial6() {
		...
		expected.append("parameter_x_join2_t = update_join2.1!(2-0) -> get_x_join2.1?x -> ((oe_x_join2.1!x -> SKIP) ||| (oe_x_join2.2!x -> SKIP))\n" +
				...
				"act1_join2 = ((oe_x_join2.2?x -> set_x_act1_join2.2!x -> SKIP)); lock_act1_join2.lock -> event_act1_join2 -> lock_act1_join2.unlock -> update_join2.3!(1-1) -> get_x_act1_join2.3?x -> ((oe_x_join2.5!(x) -> SKIP)); act1_join2\n" + 
				...
				"join1_join2 = ((oe_x_join2.3?x -> set_x_join1_join2.3!x -> SKIP) ||| (oe_x_join2.5?x -> set_x_join1_join2.4!x -> SKIP)); update_join2.4!(1-2) -> get_x_join1_join2.4?x -> ((oe_x_join2.4!x -> SKIP)); join1_join2\n" + 
