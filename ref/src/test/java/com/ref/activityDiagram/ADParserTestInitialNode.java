...
public class ADParserTestInitialNode {
	...
	public static void GetDiagram() throws Exception {
		try {
			...
			parser7 = new ADParser(ad.getActivity(), ad.getName());
	...
	public void TestNodesInitial4() {
		...
		expected.append("init1_decision1_t = update_decision1.1!(1-0) -> ((ce_decision1.1 -> SKIP))\n" + 
				...
				"parameter_x_t = update_decision1.3!(1-0) -> get_x_decision1.1?x -> ((oe_x_decision1.1!x -> SKIP))\n" + 
				...
				"dec1_decision1 = ((ce_decision1.1 -> SKIP) ||| (oe_x_decision1.1?x -> set_x_dec1_decision1.1!x -> SKIP)); update_decision1.5!(1-2) -> get_x_dec1_decision1.2?x -> (x == 1 & (ce_decision1.2 -> SKIP) [] x == 0 & (ce_decision1.3 -> SKIP)); dec1_decision1\n" + 
