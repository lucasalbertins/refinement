...
public class ADParserTestActionNode {
	...
	public void TestNodesAction3() {
		...
		expected.append("init1_action3_t = update_action3.1!(1-0) -> ((ce_action3.1 -> SKIP))\n" + 
				...
				"act1_action3 = ((ce_action3.1 -> SKIP) ||| (oe_x_action3.1?x -> set_x_act1_action3.1!x -> SKIP)); lock_act1_action3.lock -> event_act1_action3 -> lock_act1_action3.unlock -> update_action3.3!(2-2) -> get_x_act1_action3.2?x -> ((oe_x_action3.2!(x) -> SKIP) ||| (oe_x_action3.3!(x) -> SKIP)); act1_action3\n" + 
				...
				"act3_action3 = ((oe_x_action3.2?w -> set_w_act3_action3.2!w -> SKIP)); lock_act3_action3.lock -> event_act3_action3 -> lock_act3_action3.unlock -> update_action3.4!(1-1) -> get_w_act3_action3.3?w -> ((oe_x_action3.4!(w) -> SKIP)); act3_action3\n" + 
				...
				"act2_action3 = ((oe_x_action3.3?z -> set_z_act2_action3.3!z -> SKIP)); lock_act2_action3.lock -> event_act2_action3 -> lock_act2_action3.unlock -> update_action3.5!(1-1) -> get_z_act2_action3.4?z -> ((oe_x_action3.5!(z) -> SKIP)); act2_action3\n" + 
	...
	public void TestNodesAction4() {
		...
		expected.append("parameter_y_t = update_action4.1!(1-0) -> get_y_action4.1?y -> ((oe_y_action4.1!y -> SKIP))\n" + 
				...
				"act1_action4 = ((oe_x_action4.2?x -> set_x_act1_action4.1!x -> SKIP) ||| (oe_y_action4.1?y -> set_y_act1_action4.2!y -> SKIP)); lock_act1_action4.lock -> event_act1_action4 -> get_y_act1_action4.3?y -> set_x_act1_action4.3!(y) -> lock_act1_action4.unlock -> update_action4.3!(2-2) -> get_x_act1_action4.4?x -> get_y_act1_action4.5?y -> ((oe_xy_action4.3!(x) -> SKIP) ||| (oe_xy_action4.4!(x) -> SKIP)); act1_action4\n" + 
				...
				"act2_action4 = ((oe_xy_action4.3?w -> set_w_act2_action4.4!w -> SKIP)); lock_act2_action4.lock -> event_act2_action4 -> lock_act2_action4.unlock -> update_action4.4!(1-1) -> get_w_act2_action4.6?w -> ((oe_xy_action4.5!(w) -> SKIP)); act2_action4\n" + 
				...
				"act3_action4 = ((oe_xy_action4.4?w -> set_w_act3_action4.5!w -> SKIP)); lock_act3_action4.lock -> event_act3_action4 -> lock_act3_action4.unlock -> update_action4.5!(1-1) -> get_w_act3_action4.7?w -> ((oe_xy_action4.6!(w) -> SKIP)); act3_action4\n" + 
