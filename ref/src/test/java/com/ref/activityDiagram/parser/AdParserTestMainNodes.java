...
public class AdParserTestMainNodes {
	...
	public void TestMainNodeNode1() throws ParsingException {
		...
		expected.append("MAIN = action1(1); LOOP\n" +
				...
				"action1(ID_action1) = (Internal_action1(ID_action1) [|{|update_action1,clear_action1,endDiagram_action1|}|] TokenManager_action1_t(0,0))\n" +
	...
	public void TestMainNodeNode2() throws ParsingException {
		...
		expected.append("MAIN = action3(1); LOOP\n" +
				...
				"action3(ID_action3) = ((Internal_action3(ID_action3) [|{|update_action3,clear_action3,endDiagram_action3|}|] TokenManager_action3_t(0,0)) [|{|get_x_action3,set_x_action3,endActivity_action3|}|] Mem_action3)\n" +
	...
	public void TestMainNodeNode3() throws ParsingException {
		...
		expected.append("MAIN = join3(1); LOOP\n" +
				...
				"join3(ID_join3) = ((Internal_join3(ID_join3) [|{|update_join3,clear_join3,endDiagram_join3|}|] TokenManager_join3_t(0,0)) [|{|get_x_join3,set_x_join3,endActivity_join3|}|] Mem_join3)\n" +
	...
	public void TestMainNodeNode4() throws ParsingException {
		...
		expected.append("MAIN = merge3(1); LOOP\n" +
				...
				"merge3(ID_merge3) = ((Internal_merge3(ID_merge3) [|{|update_merge3,clear_merge3,endDiagram_merge3|}|] TokenManager_merge3_t(0,0)) [|{|get_x_merge3,set_x_merge3,get_y_merge3,set_y_merge3,endActivity_merge3|}|] Mem_merge3)\n" +
