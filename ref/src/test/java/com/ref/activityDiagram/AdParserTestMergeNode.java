...
public class AdParserTestMergeNode {
	...
	public void TestMergeNode1() {
		...
		expected.append("init1_merge1_t = update_merge1.1!(2-0) -> ((ce_merge1.1 -> SKIP) ||| (ce_merge1.2 -> SKIP))\n" + 
				"act1_merge1 = ((ce_merge1.1 -> SKIP)); lock_act1_merge1.lock -> event_act1_merge1 -> lock_act1_merge1.unlock -> update_merge1.2!(1-1) -> ((ce_merge1.3 -> SKIP)); act1_merge1\n" + 
				"act1_merge1_t = act1_merge1 /\\ END_DIAGRAM_merge1\n" + 
				"act2_merge1 = ((ce_merge1.2 -> SKIP)); lock_act2_merge1.lock -> event_act2_merge1 -> lock_act2_merge1.unlock -> update_merge1.3!(1-1) -> ((ce_merge1.4 -> SKIP)); act2_merge1\n" + 
	...
	public void TestMergeNode3() {
		...
		expected.append("parameter_x_t = update_merge4.1!(2-0) -> get_x_merge4.1?x -> ((oe_x_merge4.1!x -> SKIP) ||| (oe_x_merge4.2!x -> SKIP))\n" + 
				"act1_merge4 = ((oe_x_merge4.1?x -> set_x_act1_merge4.2!x -> SKIP)); lock_act1_merge4.lock -> event_act1_merge4 -> lock_act1_merge4.unlock -> update_merge4.2!(1-1) -> get_x_act1_merge4.2?x -> ((oe_x_merge4.3!(x) -> SKIP)); act1_merge4\n" + 
				...
				"act2_merge4 = ((oe_x_merge4.2?x -> set_x_act2_merge4.3!x -> SKIP)); lock_act2_merge4.lock -> event_act2_merge4 -> lock_act2_merge4.unlock -> update_merge4.3!(1-1) -> get_x_act2_merge4.3?x -> ((oe_x_merge4.4!(x) -> SKIP)); act2_merge4\n" + 
				...
				"merge1_merge4 = ((oe_x_merge4.3?x -> set_x_merge1_merge4.4!x -> SKIP) [] (oe_x_merge4.4?x -> set_x_merge1_merge4.5!x -> SKIP)); update_merge4.4!(1-1) -> get_x_merge1_merge4.4?x -> oe_x_merge4.5!x -> merge1_merge4\n" + 
