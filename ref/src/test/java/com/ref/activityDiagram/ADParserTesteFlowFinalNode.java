...
public class ADParserTesteFlowFinalNode {
	...
	public void TestNodesFlowFinal3() {
		...
		expected.append("parameter_x_t = update_flowFinal3.1!(1-0) -> get_x_flowFinal3.1?x -> ((oe_x_flowFinal3.1!x -> SKIP))\n" + 
				"act1_flowFinal3 = ((oe_x_flowFinal3.1?x -> set_x_act1_flowFinal3.2!x -> SKIP)); lock_act1_flowFinal3.lock -> event_act1_flowFinal3 -> lock_act1_flowFinal3.unlock -> update_flowFinal3.2!(1-1) -> get_x_act1_flowFinal3.2?x -> ((oe_x_flowFinal3.2!(x) -> SKIP)); act1_flowFinal3\n" + 
