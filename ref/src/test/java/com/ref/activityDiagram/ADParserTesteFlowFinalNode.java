...
public class ADParserTesteFlowFinalNode {
	...
	public void TestNodesFlowFinal1() throws ParsingException {
		...
		expected.append("init1_flowFinal1_t = update_flowFinal1.1!(1-0) -> ((ce_flowFinal1.1 -> SKIP))\n" +
				"act1_flowFinal1 = ((ce_flowFinal1.1 -> SKIP)); event_act1_flowFinal1 -> ((ce_flowFinal1.2 -> SKIP)); act1_flowFinal1\n" +
				"act1_flowFinal1_t = act1_flowFinal1 /\\ END_DIAGRAM_flowFinal1\n" +
				"flowFinal1_flowFinal1 = ((ce_flowFinal1.2 -> SKIP)); update_flowFinal1.2!(0-1) -> flowFinal1_flowFinal1\n" +
	...
	public void TestNodesFlowFinal2() throws ParsingException {
		...
		expected.append("init1_flowFinal2_t = update_flowFinal2.1!(2-0) -> ((ce_flowFinal2.1 -> SKIP) ||| (ce_flowFinal2.2 -> SKIP))\n" +
				"act1_flowFinal2 = ((ce_flowFinal2.1 -> SKIP)); event_act1_flowFinal2 -> ((ce_flowFinal2.3 -> SKIP)); act1_flowFinal2\n" +
				"act1_flowFinal2_t = act1_flowFinal2 /\\ END_DIAGRAM_flowFinal2\n" +
				"act2_flowFinal2 = ((ce_flowFinal2.2 -> SKIP)); event_act2_flowFinal2 -> ((ce_flowFinal2.4 -> SKIP)); act2_flowFinal2\n" +
				"act2_flowFinal2_t = act2_flowFinal2 /\\ END_DIAGRAM_flowFinal2\n" +
				"flowFinal1_flowFinal2 = ((ce_flowFinal2.3 -> SKIP) [] (ce_flowFinal2.4 -> SKIP)); update_flowFinal2.2!(0-1) -> flowFinal1_flowFinal2\n" +
	...
	public void TestNodesFlowFinal5() throws ParsingException {
		...
		expected.append("parameter_x_flowFinal5_t = update_flowFinal5.1!(1-0) -> get_x_flowFinal5.1?x -> ((oe_x_flowFinal5.1!x -> SKIP))\n" +
				...
				"act3_flowFinal5 = ((ce_flowFinal5.2 -> SKIP)); event_act3_flowFinal5 -> ((ce_flowFinal5.3 -> SKIP)); act3_flowFinal5\n" +
				"act3_flowFinal5_t = act3_flowFinal5 /\\ END_DIAGRAM_flowFinal5\n" +
				"flowFinal1_flowFinal5 = ((oe_x_flowFinal5.2?x -> SKIP) [] (ce_flowFinal5.3 -> SKIP)); update_flowFinal5.3!(0-1) -> flowFinal1_flowFinal5\n" +
