...
public class ADParserTesteFlowFinalNode {
	...
	public void TestNodesFlowFinal1() {
		...
		expected.append("init1_flowFinal1_t = update_flowFinal1.1!(1-0) -> ((ce_flowFinal1.1 -> SKIP))\n" + 
				"act1_flowFinal1 = ce_flowFinal1.1 -> lock_act1_flowFinal1.lock -> event_act1_flowFinal1 -> lock_act1_flowFinal1.unlock -> update_flowFinal1.2!(1-1) -> ((ce_flowFinal1.2 -> SKIP)); act1_flowFinal1\n" + 
	...
	public void TestNodesFlowFinal2() {
		...
		expected.append("init1_flowFinal2_t = update_flowFinal2.1!(2-0) -> ((ce_flowFinal2.1 -> SKIP) ||| (ce_flowFinal2.2 -> SKIP))\n" + 
				"act1_flowFinal2 = ce_flowFinal2.1 -> lock_act1_flowFinal2.lock -> event_act1_flowFinal2 -> lock_act1_flowFinal2.unlock -> update_flowFinal2.2!(1-1) -> ((ce_flowFinal2.3 -> SKIP)); act1_flowFinal2\n" + 
				"act1_flowFinal2_t = act1_flowFinal2 /\\ END_DIAGRAM_flowFinal2\n" + 
				"act2_flowFinal2 = ce_flowFinal2.2 -> lock_act2_flowFinal2.lock -> event_act2_flowFinal2 -> lock_act2_flowFinal2.unlock -> update_flowFinal2.3!(1-1) -> ((ce_flowFinal2.4 -> SKIP)); act2_flowFinal2\n" + 
				"act2_flowFinal2_t = act2_flowFinal2 /\\ END_DIAGRAM_flowFinal2\n" + 
				"flowFinal1_flowFinal2 = ((ce_flowFinal2.4 -> SKIP) [] (ce_flowFinal2.3 -> SKIP)); update_flowFinal2.4!(0-1) -> flowFinal1_flowFinal2\n" + 
	...
	public void TestNodesFlowFinal4() {
		...
		expected.append("parameter_x_t = update_flowFinal4.1!(1-0) -> get_x_flowFinal4.1?x -> ((oe_x_flowFinal4.1!x -> SKIP))\n" + 
				"act1_flowFinal4 = oe_x_flowFinal4.1?x -> lock_act1_flowFinal4.lock -> event_act1_flowFinal4 -> lock_act1_flowFinal4.unlock -> update_flowFinal4.2!(2-1) -> ((oe_x_flowFinal4.2!x -> SKIP) ||| (oe_x_flowFinal4.3!x -> SKIP)); act1_flowFinal4\n" + 
				"act1_flowFinal4_t = act1_flowFinal4 /\\ END_DIAGRAM_flowFinal4\n" + 
				"act2_flowFinal4 = oe_x_flowFinal4.2?x -> lock_act2_flowFinal4.lock -> event_act2_flowFinal4 -> lock_act2_flowFinal4.unlock -> update_flowFinal4.3!(1-1) -> ((oe_x_flowFinal4.4!x -> SKIP)); act2_flowFinal4\n" + 
				"act2_flowFinal4_t = act2_flowFinal4 /\\ END_DIAGRAM_flowFinal4\n" + 
				"act3_flowFinal4 = oe_x_flowFinal4.3?x -> lock_act3_flowFinal4.lock -> event_act3_flowFinal4 -> lock_act3_flowFinal4.unlock -> update_flowFinal4.4!(1-1) -> ((oe_x_flowFinal4.5!x -> SKIP)); act3_flowFinal4\n" + 
				"act3_flowFinal4_t = act3_flowFinal4 /\\ END_DIAGRAM_flowFinal4\n" + 
	...
	public void TestNodesFlowFinal5() {
		...
		expected.append("parameter_x_t = update_flowFinal5.1!(1-0) -> get_x_flowFinal5.1?x -> ((oe_x_flowFinal5.1!x -> SKIP))\n" + 
				"act2_flowFinal5 = oe_x_flowFinal5.1?x -> lock_act2_flowFinal5.lock -> event_act2_flowFinal5 -> lock_act2_flowFinal5.unlock -> update_flowFinal5.2!(1-1) -> ((oe_x_flowFinal5.2!x -> SKIP)); act2_flowFinal5\n" + 
				"act2_flowFinal5_t = act2_flowFinal5 /\\ END_DIAGRAM_flowFinal5\n" + 
				"init1_flowFinal5_t = update_flowFinal5.3!(1-0) -> ((ce_flowFinal5.1 -> SKIP))\n" + 
				"act1_flowFinal5 = ce_flowFinal5.1 -> lock_act1_flowFinal5.lock -> event_act1_flowFinal5 -> lock_act1_flowFinal5.unlock -> update_flowFinal5.4!(1-1) -> ((ce_flowFinal5.2 -> SKIP)); act1_flowFinal5\n" + 
				"act1_flowFinal5_t = act1_flowFinal5 /\\ END_DIAGRAM_flowFinal5\n" + 
				"act3_flowFinal5 = ce_flowFinal5.2 -> lock_act3_flowFinal5.lock -> event_act3_flowFinal5 -> lock_act3_flowFinal5.unlock -> update_flowFinal5.5!(1-1) -> ((ce_flowFinal5.3 -> SKIP)); act3_flowFinal5\n" + 
				"act3_flowFinal5_t = act3_flowFinal5 /\\ END_DIAGRAM_flowFinal5\n" + 
				"flowFinal1_flowFinal5 = ((ce_flowFinal5.3 -> SKIP) [] (oe_x_flowFinal5.2?x -> SKIP)); update_flowFinal5.6!(0-1) -> flowFinal1_flowFinal5\n" + 
