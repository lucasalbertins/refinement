...
public class ADParserTestJoinNode {
	...
	public void TestNodesJoin2() {
		...
		expected.append("parameter_x_t = update_join2.1!(2-0) -> get_x_join2.1?x -> ((oe_x_join2.1!x -> SKIP) ||| (oe_x_join2.2!x -> SKIP))\n" + 
				"act2_join2 = ((oe_x_join2.1?x -> set_x_act2_join2.2!x -> SKIP)); lock_act2_join2.lock -> event_act2_join2 -> lock_act2_join2.unlock -> update_join2.2!(1-1) -> get_x_act2_join2.2?x -> ((oe_x_join2.3!(x) -> SKIP)); act2_join2\n" + 
				...
				"act1_join2 = ((oe_x_join2.2?x -> set_x_act1_join2.3!x -> SKIP)); lock_act1_join2.lock -> event_act1_join2 -> lock_act1_join2.unlock -> update_join2.3!(1-1) -> get_x_act1_join2.3?x -> ((oe_x_join2.4!(x) -> SKIP)); act1_join2\n" + 
				...
				"join1_join2 = ((oe_x_join2.3?x -> set_x_join1_join2.4!x -> SKIP) ||| (oe_x_join2.4?x -> set_x_join1_join2.5!x -> SKIP)); update_join2.4!(1-2) -> get_x_join1_join2.4?x -> ((oe_x_join2.5!x -> SKIP)); join1_join2\n" + 
	...
	public void TestNodesJoin3() {
		...
		expected.append("parameter_x_t = update_join3.1!(1-0) -> get_x_join3.1?x -> ((oe_x_join3.1!x -> SKIP))\n" + 
				...
				"act1_join3 = ((oe_x_join3.2?x -> set_x_act1_join3.3!x -> SKIP)); lock_act1_join3.lock -> event_act1_join3 -> lock_act1_join3.unlock -> update_join3.4!(1-1) -> get_x_act1_join3.3?x -> ((oe_x_join3.3!(x) -> SKIP)); act1_join3\n" + 
	...
	public void TestNodesJoin4() {
		...
		expected.append("parameter_y_t = update_join4.1!(1-0) -> get_y_join4.1?y -> ((oe_y_join4.1!y -> SKIP))\n" + 
				...
				"join1_join4 = ((oe_y_join4.1?y -> set_y_join1_join4.3!y -> SKIP) ||| (oe_x_join4.2?x -> set_x_join1_join4.4!x -> SKIP)); update_join4.3!(1-2) -> get_y_join1_join4.3?y -> get_x_join1_join4.4?x -> ((oe_yx_join4.3!y -> SKIP) |~| (oe_yx_join4.3!x -> SKIP)); join1_join4\n" + 
				...
				"act1_join4 = ((oe_yx_join4.3?x -> set_x_act1_join4.5!x -> SKIP)); lock_act1_join4.lock -> event_act1_join4 -> lock_act1_join4.unlock -> update_join4.4!(1-1) -> get_x_act1_join4.5?x -> ((oe_yx_join4.4!(x) -> SKIP)); act1_join4\n" + 
				...
				"fin1_join4 = ((oe_yx_join4.4?yx -> SKIP)); clear_join4.1 -> SKIP\n" + 
