...
public class ADParserTestJoinNode {
	...
	public void TestNodesJoin4() {
		...
		expected.append("parameter_y_t = update_join4.1!(1-0) -> get_y_join4.1?y -> ((oe_y_join4.1!y -> SKIP))\n" + 
				...
				"join1_join4 = ((oe_y_join4.1?y -> set_y_join1_join4.3!y -> SKIP) ||| (oe_x_join4.2?x -> set_x_join1_join4.4!x -> SKIP)); update_join4.3!(1-2) -> get_y_join1_join4.3?y -> get_x_join1_join4.4?x -> ((oe_y_join4.3!y -> SKIP) |~| (oe_x_join4.4!x -> SKIP)); join1_join4\n" + 
				"join1_join4_t = (((join1_join4 /\\ END_DIAGRAM_join4) [|{|get_y_join1_join4,set_y_join1_join4,endDiagram_join4|}|] Mem_join1_join4_y_t(0)) [|{|get_x_join1_join4,set_x_join1_join4,endDiagram_join4|}|] Mem_join1_join4_x_t(0)) \\{|get_x_join1_join4,set_x_join1_join4,get_y_join1_join4,set_y_join1_join4|}\n" + 
