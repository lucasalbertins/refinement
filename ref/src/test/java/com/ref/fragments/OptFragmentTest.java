...
public class OptFragmentTest {
    ...
    public void testParseSD1(){
        ...
        expected1.append("(B_mOP.s!lf1_id!lf2_id.m2_I -> SKIP);");
        expected1.append("(B_mOP.r!lf2_id!lf1_id?out:{x | x <-B_OPS,(get_id(x) == m2_O)} -> SKIP)\n");
//        expected1.append("[]\n");
//        expected1.append("g2 & (B_mOP.s!lf1_id!lf2_id.m2_I -> SKIP);(B_mOP.r!lf2_id!lf1_id?out:{x | x <-B_OPS,(get_id(x) == m2_O)} -> SKIP))\n");
        ...
        expected1.append("opt1?g1 -> (g1 & (A_mSIG.s!lf2_id!lf1_id.m1 -> SKIP));");
        expected1.append("(B_mOP.r!lf1_id!lf2_id?oper:{x | x <- B_OPS,(get_id(x) == m2_I)} -> SKIP);");
//        expected1.append("[]\n");
